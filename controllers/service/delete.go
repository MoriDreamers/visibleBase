...
func Delete(r *gin.Context) {
	...
	err = clientset.CoreV1().Services(basicInfo.Namespace).Delete(context.TODO(), basicInfo.Name, metav1.DeleteOptions{})

	if err != nil {
		msg := "service删除失败" + err.Error()
		returnData.Status = 401
		returnData.Message = msg
		r.JSON(200, returnData)
		return
	...
	returnData.Message = "删除service成功"
	r.JSON(200, returnData)
}
