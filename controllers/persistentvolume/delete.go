...
func Delete(r *gin.Context) {
	...
	err = clientset.CoreV1().PersistentVolumes().Delete(context.TODO(), basicInfo.Name, metav1.DeleteOptions{})

	if err != nil {
		msg := "persistentvolume 删除失败" + err.Error()
		returnData.Status = 401
		returnData.Message = msg
		r.JSON(200, returnData)
		return
	...
	returnData.Message = "删除persistentvolume 成功"
	r.JSON(200, returnData)
}
