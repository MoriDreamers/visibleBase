...
func Delete(r *gin.Context) {
	...
	err = clientset.StorageV1().StorageClasses().Delete(context.TODO(), basicInfo.Name, metav1.DeleteOptions{})

	if err != nil {
		msg := "storageclass 删除失败" + err.Error()
		returnData.Status = 401
		returnData.Message = msg
		r.JSON(200, returnData)
		return
	...
	returnData.Message = "删除storageclass 成功"
	r.JSON(200, returnData)
}
